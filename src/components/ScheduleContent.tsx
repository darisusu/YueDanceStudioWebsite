            ...
            <tr>
              {activeDayIndices.map(di => (
                <th
                  key={di}
                  scope="col"
                  className="bg-ink border border-ink px-4 py-5 text-left align-middle"
                >
                  <p className="font-display text-2xl lg:text-3xl text-ivory leading-none">
                    {tr.days[di][language]}
                  </p>
                  {language === 'en' && (
