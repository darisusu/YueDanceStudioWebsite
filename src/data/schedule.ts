...
export const scheduleClasses: ScheduleClass[] = [
  // Monday
  { day: 0, band: 0, time: '10:00–11:30am', name: { en: 'Contemporary Chinese Dance',       zh: '当代中国舞'      }, instructor: { en: 'Daniel',          zh: 'Daniel'  } },
  ...
  { day: 1, band: 4, time: '7:30–9:00pm',   name: { en: 'Chinese Dance',                    zh: '中国舞'          }, instructor: { en: 'Angel Peng',      zh: '彭若丹'  } },
  // Wednesday
  ...
  // Thursday
  { day: 3, band: 0, time: '10:00–11:30am', name: { en: 'Contemporary Chinese Dance',       zh: '当代中国舞'      }, instructor: { en: 'Daniel',          zh: 'Daniel'  } },
  ...
  { day: 5, band: 2, time: '3:00–4:30pm',   name: { en: 'Contemporary Chinese Dance',       zh: '当代中国舞'      }, instructor: { en: 'Daniel',          zh: 'Daniel'  } },
