...
export type DanceType = 'contemporary' | 'ballet' | 'chinese-dance' | 'folk' | 'classical';
...
export const scheduleClasses: ScheduleClass[] = [
  ...
  // Thursday
  { day: 3, band: 0, time: '10:00–11:30am', name: { en: 'Contemporary Chinese Dance',       zh: '当代华族舞'      }, instructor: { en: 'Daniel',          zh: 'Daniel'  }, danceType: 'chinese-dance' },
  { day: 3, band: 1, time: '12:00–1:30pm',  name: { en: 'Contemporary Dance',               zh: '现当代舞'        }, instructor: { en: 'Daniel',          zh: 'Daniel'  }, danceType: 'contemporary' },
  { day: 3, band: 4, time: '7:30–9:30pm',   name: { en: 'Han Chinese Yangge Folk Dance',    zh: '汉族秧歌民间舞'  }, instructor: { en: 'Bai Ying Wen',   zh: '白映文'  }, danceType: 'folk' },
  // Friday
